...
public class WaterMarkUtils {
    ...
    public void addWaterMark(String srcImgPath, String tarImgPath, String waterMarkContent, Color markContentColor, Font font) {
        ...
        try {
            ...
            //设置水印的坐标
            int x = Integer.parseInt(new java.text.DecimalFormat("0").format(srcImgWidth*0.009));
            int y = Integer.parseInt(new java.text.DecimalFormat("0").format(srcImgHeight*0.50));
            //int x = 15;
           // int y = 575;
    ...
    public static void main(String[] args) {
        ...
        String srcImgPath = "D:/其他/3.jpg"; //源图片地址
        String tarImgPath = "D:/其他/5.jpg"; //待存储的地址
        String waterMarkContent = "111111111111111111111";  //水印内容
